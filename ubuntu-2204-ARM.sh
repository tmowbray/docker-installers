...
download_compose () {
	...
	curl -fL https://github.com/docker/compose-switch/releases/latest/download/docker-compose-linux-armv7 -o /usr/local/bin/compose-switch && chmod +x /usr/local/bin/compose-switch
}
